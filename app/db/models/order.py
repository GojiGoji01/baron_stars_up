...
class Order(Base):
    ...
    payment_transaction_id: Mapped[str | None] = mapped_column(String(128), index=True, nullable=True)
    ...
    fragment_transaction_id: Mapped[str | None] = mapped_column(String(128), index=True, nullable=True)
